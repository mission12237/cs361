...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints "PART TIME EMPLOYEE", because It is over written from pemp1
		// emp3.getHourlyRate(); // because this method does not exist in the Employee class 
		...
		// because Since superclass cannot be converted to subclass, Employee are superclass and PartTimeEmployee are subclass.
